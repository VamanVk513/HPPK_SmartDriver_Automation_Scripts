...
window.onload = function() {
    ...
    submitButton.addEventListener("click", function(){
        //Info: This codes is for creating a new browser tab when making new Test Case        
        toggleModal();

        var openUrl = document.getElementById("urlBox").value;
        ...
        if(openUrl){            
            ...
            var creating = browser.tabs.create({url:openUrl});            
        }
        else{
