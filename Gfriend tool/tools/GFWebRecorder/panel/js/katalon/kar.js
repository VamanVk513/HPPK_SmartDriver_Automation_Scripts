    ...
    switch (language) {
        case 'gfriend':            
            scriptNames = [
                ...
                'js/katalon/selenium-ide/format/gfriend/gfriend.js'
            ];            
            break;
        case 'cs-wd-nunit':
            scriptNames = [
...
$(function() {
    $('#record').attr('title', "Click and navigate to the desired browser tab and record your tests. NOTE: If the tab has been opened before GFriend Web Recorder was installed, please refresh it.");
    $('#playback').attr('title', "Run selected test case on the active tab, any interference may stop the process. NOTE: If the tab has been opened before GFriend Web Recorder was installed, please refresh it.");
    $('#playSuite').attr('title', "Run selected test suite on the active tab, any interference may stop the process. NOTE: If the tab has been opened before GFriend Web Recorder was installed, please refresh it.");
    $('#playSuites').attr('title', "Run all test suites on the active tab, any interference may stop the process. NOTE: If the tab has been opened before GFriend Web Recorder was installed, please refresh it.");
    ...
    $('#export').attr('title', "Export the current test case to script in GFriend, Robot Framework, or XML");
...
$(function() {
    ...
    $(document).attr('title', 'GFriend Web Recorder(Beta) ' + manifestData.version)
});
...
function showDialog(html, showOK) {
    ...
    return $('<div></div>')
        .html(html)
        .dialog({
            title: 'GFriend Web Recorder(Beta)',
            resizable: false,
            height: "auto",
            width: 400,
            modal: true,
